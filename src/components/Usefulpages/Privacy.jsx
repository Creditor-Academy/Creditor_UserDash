            ...
            <article className="prose prose-slate max-w-none">
              <section id="intro" className="mb-10 sm:mb-12">
                <p className="text-slate-700">
                  Athena LMS ("we", "our", "us") respects your privacy and is committed to protecting
                  your personal data. This Privacy Policy explains what information we collect, how we use it,
                  and the choices you have. By using Athena LMS, you agree to the practices described below.
                </p>
              </section>
              ...
              <section id="who-we-are" className="mt-10 sm:mt-12">
                ...
                <p className="text-slate-700">
                  ...
                  <a href="mailto:counselor@lmsathena.com" className="text-sky-700 underline">
              ...
              <section id="information-we-collect" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">Information we collect</h2>
                <ul className="list-disc pl-6 space-y-3 text-slate-700">
                  <li><strong>Account & profile data:</strong> name, email, avatar, organization, preferences.</li>
                  <li><strong>Learning activity:</strong> enrollments, progress, and course feedback.</li>
                  <li><strong>Payment data:</strong> billing info handled by secure payment processors.</li>
                  <li><strong>Usage & device data:</strong> IP address, browser type, and session analytics.</li>
                  <li><strong>Support communications:</strong> messages and attachments from user support.</li>
                </ul>
              </section>

              <section id="how-we-use" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">How we use your information</h2>
                <ul className="list-disc pl-6 space-y-3 text-slate-700">
              ...
              <section id="cookies" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">Cookies and similar technologies</h2>
                <p className="text-slate-700">
                  We use cookies to enhance experience, remember preferences, and analyze performance.
                  You can manage cookies via browser settings. Essential cookies are required for core functions.
                </p>
              </section>

              <section id="when-we-share" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">When we share information</h2>
                <p className="text-slate-700 mb-3">We only share necessary data with:</p>
                <ul className="list-disc pl-6 space-y-3 text-slate-700">
                  <li><strong>Service providers:</strong> hosting, analytics, and secure payment partners.</li>
                  <li><strong>Organizations:</strong> your company or academy managing your account.</li>
                  <li><strong>Legal authorities:</strong> if required by law or to protect users.</li>
                </ul>
              </section>
              ...
              <section id="data-security" className="mt-10 sm:mt-12">
                ...
                <p className="text-slate-700">
                  We apply administrative and technical safeguards to protect data. While no system is
                  completely secure, we continuously enhance our controls and monitoring systems.
                </p>
              </section>

              <section id="your-rights" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">Your rights and choices</h2>
                <ul className="list-disc pl-6 space-y-3 text-slate-700">
              ...
              <section id="children" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">Children’s privacy</h2>
                <p className="text-slate-700">
                  Athena LMS is not designed for users under 16. If we learn such data was collected, we will
                  delete it promptly.
                </p>
              </section>
              ...
              <section id="data-retention" className="mt-10 sm:mt-12">
                ...
                <p className="text-slate-700">
                  We retain personal data only as long as necessary to deliver services, comply with laws,
                  and resolve disputes.
                </p>
              </section>

              <section id="international" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">International transfers</h2>
                <p className="text-slate-700">
                  We may process data in other countries. All transfers follow legal safeguards and standards.
                </p>
              </section>

              <section id="changes" className="mt-10 sm:mt-12">
                <h2 className="font-semibold text-slate-800">Changes to this policy</h2>
                <p className="text-slate-700">
                  We may update this Privacy Policy periodically. Revisions will be posted here with a new
                  “Last Updated” date.
                </p>
              </section>
                  ...
                  <li key={s.id}>
                    <button
                      ...
                      className={`text-left w-full ${
                        activeId === s.id ? "text-sky-600 font-semibold" : "text-slate-700"
                      } hover:underline`}
                    >
                      {s.title}
                    </button>
