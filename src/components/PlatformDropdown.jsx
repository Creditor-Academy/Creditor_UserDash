          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-1 p-6 lg:p-8">
              ...
              <div className="flex flex-col gap-6">
                <a href="/platform/courses" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                  <h4 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Courses</h4>
                  <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors">Easily create and sell show-stopping, profitable courses</p>
                </a>
                <a href="/platform/communities" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                  <h4 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Communities</h4>
                  <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors">Grow your business with shared online learning spaces</p>
                </a>
                <a href="/platform/digital-downloads" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                  <h4 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Digital Downloads</h4>
                  <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors">Generate leads and revenue with digital products</p>
                </a>
                <a href="/platform/memberships" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                  <h4 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Memberships</h4>
                  <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors">Generate recurring revenue by offering exclusive perks</p>
                </a>
                <a href="/platform/coaching" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                  <h4 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Coaching and Webinars</h4>
                  <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors">Build deeper connections with live learning experiences</p>
                </a>
              </div>
            </div>
            ...
            <div className="flex-1 p-6 lg:p-8 border-t lg:border-t-0 lg:border-l border-gray-200">
              ...
              <div className="flex flex-col gap-6">
                <a href="/website" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
            ...
            <div className="flex-1 p-6 lg:p-8 border-t lg:border-t-0 lg:border-l border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-6">Commerce Tools</h3>
              <div className="flex flex-col gap-6">
                <a href="/pricing" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                ...
                <a href="/instructionaldesign" className="block group cursor-pointer p-3 rounded-lg transition-all duration-200 hover:bg-blue-50">
                  <h4 className="text-base font-semibold text-gray-900 mb-2 group-hover:text-blue-600 transition-colors">Time-Saving Tools</h4>
                  <p className="text-sm text-gray-600 group-hover:text-gray-700 transition-colors">Automate and streamline time-consuming admin tasks like taxes</p>
                </a>
              </div>
            </div>
          </div>
