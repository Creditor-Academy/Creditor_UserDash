  ...
  const features = [
    {
      ...
      title: "Time to value",
      description: "Get your program up and running in a few weeks so you can reduce churn right away and prove value quickly."
    },
    {
      icon: <Users className="w-7 h-7" />,
      iconBg: "bg-gradient-to-br from-emerald-500 to-emerald-600",
      title: "Ease of use",
      description: "Enjoy a flexible, feature-rich platform that's refreshingly easy to use — for both admins and learners."
    },
    {
      icon: <Brain className="w-7 h-7" />,
      iconBg: "bg-gradient-to-br from-purple-500 to-purple-600",
      title: "AI-powered efficiency",
      description: "Tap into a suite of AI-driven tools built to accelerate content creation and help you reach your goals faster."
    },
    {
      icon: <Plug className="w-7 h-7" />,
      iconBg: "bg-gradient-to-br from-orange-500 to-orange-600",
      title: "Seamless tech integration",
      description: "Athena connects with the tools you already use, creating a smooth, unified workflow across your business."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-normal text-gray-900 mb-4 leading-tight" style={{ fontFamily: 'Georgia, Times New Roman, serif' }}>
            Why top businesses use <span className="text-blue-600">Athena</span> for revenue generation
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto font-normal" style={{ fontFamily: 'Arial, sans-serif' }}>
            Empower your training programs with a comprehensive platform designed for growth and success
          </p>
        </div>
