...
const LeadFeatures = () => {
  ...
  const features = [
    {
      title: "Landing Pages",
      description: "Create high-converting landing pages with built-in A/B testing, SEO optimization, and seamless lead capture forms.",
    ...
    },
    {
      ...
      description: "Build automated email sequences that nurture leads through personalized content and targeted messaging based on behavior.",
      image: "https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=400&h=200&fit=crop&crop=edges",
    ...
    {
      title: "Lead Tracking",
      description: "Monitor every interaction and engagement point to understand exactly where your leads are in the buyer's journey.",
    ...
    },
    {
      ...
      description: "Seamlessly sync leads with your CRM and marketing automation tools for a unified lead management workflow.",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&h=200&fit=crop&crop=edges",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto font-normal" style={{ fontFamily: 'Arial, sans-serif' }}>
            Build, capture, and nurture leads with features designed to maximize conversions and grow your pipeline.
          </p>
        </motion.div>
