      ...
      <div className="thinkific-wrap">
        <div className="left-copy">
          <h1 className="headline">
            ...
            <span className="block">programs with <span className="block">LMS Athena</span></span>
          </h1>
          <p className="copy">
          ...
          <ul className="bullets">
            <li><span className="dot" />Find out if LMS Athena meets your needs. If not, we’ll point you in the right direction.</li>
            <li><span className="dot" />Share your short and long–term goals and discuss what’s getting in the way.</li>
            <li><span className="dot" />Learn how companies like yours are using LMS Athena to launch, scale, and streamline education programs that drive revenue and engagement.</li>
          </ul>
