  ...
  return (
    <section className="principles-section" style={{
      ...
      <div className="principles-container">
        ...
        >
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-normal leading-tight" style={{ fontFamily: 'Georgia, Times New Roman, serif' }}>
            <span className="text-black">Mission & Vision</span>
          </h2>
        </motion.div>
          <p className="principles-description text-lg text-gray-600 font-normal" style={{ fontFamily: 'Arial, sans-serif', marginTop: '8px' }}>
          ...
          },
          {
            ...
            >
              ...
              <div className="card-overlay overlay-active">
                <h2 className="overlay-title text-lg font-bold text-gray-900" style={{ fontFamily: 'Arial, sans-serif' }}>
                  {p.title}
                </h2>
                <p className="overlay-description text-sm text-gray-600 leading-relaxed" style={{ fontFamily: 'Arial, sans-serif' }}>
                  {p.desc}
                </p>
