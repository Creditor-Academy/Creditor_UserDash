...
import { ImagesTab, SummarizationTab, SearchTab } from './AIWorkspaceTabs';
import aiCourseService from '../../services/aiCourseService';

const AIWorkspaceFullScreenComplete = ({ isOpen, onClose, initialCourseData, onSave }) => {
...
export default AIWorkspaceFullScreenComplete;
