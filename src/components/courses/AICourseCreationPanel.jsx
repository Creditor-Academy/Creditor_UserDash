                          ...
                          <div className="space-y-4">
                            ...
                            <div>
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                ...
                                >
                                  <div className="font-semibold text-sm text-gray-900">⚡ Quick</div>
                                  <div className="text-xs text-gray-500 mt-1">Fast, minimal content</div>
                                </button>
                                ...
                                >
                                  ...
                                  <div className="text-xs text-gray-500 mt-1">Balanced quality</div>
                                </button>
                                ...
                                >
                                  <div className="font-semibold text-sm text-gray-900">💎 Complete</div>
                                  <div className="text-xs text-gray-500 mt-1">Rich multimedia</div>
                                </button>
                                ...
                                >
                                  <div className="font-semibold text-sm text-gray-900">👑 Premium</div>
                                  <div className="text-xs text-gray-500 mt-1">Highest quality</div>
                                </button>
                              </div>
                            </div>
