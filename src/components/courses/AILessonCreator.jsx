    ...
    try {
      ...
      const mockLessons = [
        ...
        },
        {
          ...
          description: 'Dive deep into the essential concepts that drive this field',
        ...
        },
        {
          ...
          description: 'Learn advanced approaches used by professionals in the field',
        ...
        return (
          <div className="p-4 border border-gray-200 rounded-lg bg-white text-center">
            ...
            {block.content.caption && (
              <p className="mt-2 text-sm text-gray-600">{block.content.caption}</p>
            )}
          </div>
        );
      case 'video':
        ...
        return (
          <div className="p-4 border border-gray-200 rounded-lg bg-white">
            ...
            {block.content.description && (
              <p className="mt-2 text-sm text-gray-600">{block.content.description}</p>
            )}
          </div>
        );
      case 'pdf':
        return (
          <div className="p-4 border border-gray-200 rounded-lg bg-white">
            {block.content.url ? (
              <div className="relative pb-[100%] h-0"> {/* 1:1 Aspect Ratio for PDF preview */}
                <iframe
                  src={block.content.url}
                  className="absolute top-0 left-0 w-full h-full rounded"
                  frameBorder="0"
          ...
          <div className="p-4 border border-gray-200 rounded-lg bg-white">
            {block.content.packageUrl ? (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-600 mt-1">{block.content.title}</p>
              </div>
            ) : (
              <div className="bg-gray-100 border-2 border-dashed border-gray-300 rounded-xl w-full h-24 flex items-center justify-center">
              ...
              {lessons.map((lesson, index) => (
                <div 
                  ...
                  className={`p-3 rounded-lg border cursor-pointer transition-colors ${
                    ...
                    (activeTab === 'blocks' && editingBlockLessonId === lesson.id)
            ...
            {lessons.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-500 text-sm">
                  {isGenerating ? 'Generating AI lessons...' : 'No lessons generated yet'}
                </p>
                {isGenerating && (
                  <div className="mt-3">
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                    ...
                    >
                      {isGenerating ? (
                        ...
                        <>
                          ...
                          <span className="hidden sm:inline">Regenerate Lessons</span>
                  ...
                  {lessons.length > 0 ? (
                    <div className="space-y-4">
                      {lessons.map((lesson, index) => (
                        <div key={`${lesson.id}-${index}`} className="bg-white border border-gray-200 rounded-lg p-4">
                          ...
                          <div className="mt-3">
                            ...
                            <ul className="list-disc list-inside space-y-1">
                              {lesson.keyPoints.map((point, pointIndex) => (
                                <li key={`${point}-${pointIndex}`} className="text-sm text-gray-600">{point}</li>
                              ))}
                            </ul>
                          </div>
              ...
              <div className="space-y-6">
                <div className="space-y-4">
                    ...
                    >
                      {isSaving ? (
                        ...
                        <>
                          ...
                          <span className="hidden sm:inline">Save All Lessons</span>
                          <span className="sm:hidden">Save</span>
                        </>
                      )}
                    </Button>
                  ...
                  {lessons.length > 0 ? (
                    <div className="space-y-4">
                      {lessons.map((lesson) => (
                        <div key={`${lesson.id}-${lesson.title}`} className="bg-white border border-gray-200 rounded-lg">
                    ...
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">No Lessons to Edit</h3>
                  ...
                  {lessons.length > 0 ? (
                    <div className="space-y-6">
                      <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6">
                        <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-2">{courseTitle}</h2>
                        <p className="text-gray-600 mb-6">
                          This course contains {lessons.length} comprehensive lessons designed to take you from beginner to proficient.
                        </p>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-3">
                            {lessons.map((lesson, index) => (
                              <div key={`${lesson.id}-${index}`} className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="text-center py-12">
                      ...
                      <h3 className="text-lg font-medium text-gray-900 mb-2">No Lessons to Preview</h3>
                      <p className="text-gray-500">
                        Generate lessons first in the "AI Lessons" tab.
                      </p>
                    </div>
