  ...
  return (
    <div className="p-6 overflow-y-auto h-full bg-gray-50">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          <h3 className="text-xl font-semibold text-gray-900 mb-2">Course Structure Overview</h3>
          <p className="text-gray-600">
            Review and navigate through your course modules and lessons. Click on any item to edit its content.
          </p>
        </div>
              ...
              <CardContent className="pt-0">
                ...
                <div className="flex items-center gap-4 mb-4 text-sm text-gray-500">
                  <div className="flex items-center gap-1">
                    ...
                    <span>{lessons.filter(l => l.moduleId === module.id).length} lessons</span>
                  </div>
                  <div className="flex items-center gap-1">
        ...
        {modules.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Course Outline Available</h3>
            <p className="text-gray-600">
