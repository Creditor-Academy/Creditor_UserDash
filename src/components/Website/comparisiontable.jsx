...
export default function ComparisonTable({
  ...
  const renderCell = (value, highlight = false) => {
    ...
    if (!value) return <span className="text-sm sm:text-base text-gray-500">—</span>;
  ...
  return (
    <section className={`w-full py-20 px-4 relative overflow-hidden ${className}`} aria-label="Plan comparison table" style={{
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-normal py-6 sm:py-20 text-gray-900 mb-4 leading-tight" style={{ fontFamily: 'Georgia, Times New Roman, serif' }}>
            Starter vs Cadillac — at a glance
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto font-normal" style={{ fontFamily: 'Arial, sans-serif' }}>
          ...
          <div className="w-full rounded-xl shadow-lg ring-1 ring-black/5 bg-gradient-to-b from-white to-indigo-50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 items-stretch p-4">
              ...
              <div className="flex items-center">
                <div className="text-base sm:text-lg font-medium text-gray-600">Features</div>
              </div>
              ...
              <div className="rounded-lg bg-white p-4 flex flex-col justify-between border hover:shadow-lg transition">
                <div>
                  ...
                  <div className="mt-2 flex items-baseline gap-2">
                    <span className="text-xl sm:text-2xl font-bold text-gray-900">$99</span>
                    <span className="text-xs sm:text-sm text-gray-500">Starter Plan</span>
                  </div>
                  {/* Maintenance Charge */}
              ...
              <div className="rounded-lg bg-gradient-to-b from-white to-indigo-100 p-4 flex flex-col justify-between border border-indigo-100 hover:shadow-xl transition">
                <div>
                  ...
                  <div className="mt-2 flex items-baseline gap-2">
                    <span className="text-xl sm:text-2xl font-bold text-gray-900">$998</span>
                    <span className="text-xs sm:text-sm text-gray-500">Cadillac Plan</span>
                  </div>
                  {/* Maintenance Charge */}
                  <p className="text-sm sm:text-base font-bold text-black mt-1">
                    + $49/month Maintenance + Hosting
            ...
            <div className="divide-y divide-gray-100 bg-white rounded-b-lg">
              {features.map((f, idx) => {
                ...
                return (
                  ...
                  >
                    <div>
                      <div className="text-base sm:text-lg font-medium text-gray-900" style={{ fontFamily: 'Arial, sans-serif' }}>{f.label}</div>
                      {f.note ? <div className="text-sm sm:text-base text-gray-600 mt-1" style={{ fontFamily: 'Arial, sans-serif' }}>{f.note}</div> : null}
                    </div>
