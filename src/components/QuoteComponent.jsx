    ...
    <>
      ...
      <Dialog open={showQuoteEditDialog} onOpenChange={setShowQuoteEditDialog}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              Edit {editingQuoteBlock?.textType?.replace('_', ' ').replace(/\b\w/g, l => l.toUpperCase())}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            {editingQuoteBlock?.textType === 'quote_carousel' ? (
              <div className="space-y-6">
                ...
                {carouselQuotes.map((quote, index) => (
                  <div key={index} className={`${activeCarouselTab === index ? 'block' : 'hidden'} space-y-4`}>
                    <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-4 border border-indigo-100">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <textarea
                            value={quote.quote}
                            onChange={(e) => handleCarouselQuoteChange(index, 'quote', e.target.value)}
                        ...
                        <div>
                          ...
                          <input
                            type="text"
                            value={quote.author}
                            onChange={(e) => handleCarouselQuoteChange(index, 'author', e.target.value)}
                    ...
                    <div className="bg-white border border-gray-200 rounded-lg p-4">
                      <h5 className="text-sm font-medium text-gray-600 mb-3">Preview:</h5>
          ...
          <DialogFooter>
            ...
            <Button 
              ...
              disabled={
                editingQuoteBlock?.textType === 'quote_carousel' 
                  ? carouselQuotes.some(q => !q.quote.trim() || !q.author.trim())
