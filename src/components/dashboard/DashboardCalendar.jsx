...
export function DashboardCalendar() {
  ...
  const liveEventsCount = selectedDateEvents.filter(
    event => event.isLive
  ).length;

  return (
    <Card className="border shadow hover:shadow-lg transition-all duration-300 hover:border-primary/20 group w-full">
              ...
              renderDay={day => {
                ...
                return (
                  <div className="flex flex-col items-center justify-center w-full h-full">
                    ...
                    {hasEvent && (
                      <span
                        className={`w-1.5 h-1.5 mt-0.5 rounded-full inline-block ${
