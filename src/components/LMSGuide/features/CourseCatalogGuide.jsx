...
import { Library, Search, ShoppingCart, Star } from 'lucide-react';
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <motion.div 
              ...
              transition={{ duration: 2, repeat: Infinity }}
            />
            <span className="text-blue-100 text-sm font-medium">Available Courses</span>
          </div>
        </div>
      </div>
      
      <p className="relative z-10 text-blue-50 text-lg leading-relaxed max-w-3xl">
        Explore our <span className="text-yellow-300 font-semibold">comprehensive collection</span> of courses. 
        Browse, select, and purchase the courses that align with your learning goals.
      </p>
    </motion.div>
  </div>
);
    ...
    videos: [
      {
        ...
        description: 'Learn how to navigate and purchase courses from our extensive catalog.'
      }
    ],
    steps: [
      {
        title: 'Browsing Available Courses',
        renderDescription: () => (
          <div className="space-y-8 ml-4">
            ...
            >
              <StepCard
                ...
                color="blue"
                items={[
                  'Click on the "Course Catalog" button in the sidebar',
                  'Browse through various courses provided by the organization',
                  'Use filters and search to find specific courses'
                ]}
                index={0}
              />
            </motion.div>
            ...
            >
              <StepCard
                ...
                color="emerald"
                items={[
                  'Select the catalog you want to purchase',
                  'Complete the purchase process securely',
                  'Access purchased courses in the "My Courses" section'
                ]}
                index={1}
              />
            </motion.div>
            ...
            >
              <ProTip emoji="🎯">
                <span className="font-bold">Easy Access:</span> After purchasing a catalog, 
                you can immediately access all your purchased courses through the "My Courses" 
