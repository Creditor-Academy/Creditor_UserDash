            ...
            >
              <StepCard
                ...
                items={[
                  ...
                  'Access quick actions and settings from the top menu bar'
                ]}
                index={0}
              />
            </motion.div>
          ...
          <div className="space-y-8 ml-4">
            ...
            >
              <StepCard
                ...
                color="purple"
                items={[
                  'Customize notification preferences for each conversation',
                  'Use rich text formatting for better message organization',
            ...
            >
              <StepCard
                ...
                color="cyan"
                items={[
                  'Set up custom notification sounds for important contacts',
                  'Configure privacy settings for your online status',
            ...
            >
              <ProTip emoji="🔐">
                <span className="font-bold">Privacy Tip:</span> Regularly review your chat privacy settings 
                and manage your notification preferences to maintain a comfortable communication environment.
              </ProTip>
            </motion.div>
          </div>
        )
