...
const features = [
  {
    ...
    description: " Use advanced insights to guide your content development and marketing strategies — and improve your audience’s experience.",
    mockupBg: "bg-[#e8e8e8]",
  ...
  },
  {
    ...
    description:"By identifying patterns in engagement data and conversion, you can take proactive steps to better meet your audience’s needs.",
    mockupBg: "bg-[#e8e8e8]",
  ...
  },
  {
    ...
    description: "Unlock the full potential of your data with personalized dashboards, enabling you to easily measure the metrics that matter most to you.",
    mockupBg: "bg-[#e8e8e8]",
