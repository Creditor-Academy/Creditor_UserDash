...
import { Video, Type, FileText, Mic, Image as ImageIcon, Presentation, Settings, Sparkles, Layers } from 'lucide-react';
...
const features = [
  {
    ...
    description: " Curate the ideal learning experience that reflects your unique area of expertise with your choice of courses, communities, digital downloads, and live events in one place.",
    mockupBg: "bg-[#e8e8e8]",
  ...
  },
  {
    ...
    description: "Foster a sense of belonging and community among audience members who share common interests or goals, leading to stronger engagement and loyalty over time.",
    mockupBg: "bg-[#e8e8e8]",
  ...
  },
  {
    ...
    description: "Deepen your relationship with your audience by offering ongoing value and support — elements that build trust and advocacy for your brand.",
    mockupBg: "bg-[#e8e8e8]",
    ...
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-20 sm:py-24 lg:py-32">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          Whether your goal is to grow your community, earn more revenue, or engage and retain your audience, memberships can help.          </p>
        </motion.div>
                    ...
                    <div className="relative w-full max-w-[260px]">
                      <div className="bg-white rounded-lg shadow-xl p-2">
                        <div className="w-full h-40 overflow-hidden flex items-center justify-center bg-gray-50 rounded">
                          <img src={communityImage} alt="Community preview" className="w-full h-full object-contain" />
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {feature.showEmail && (
                    <div className="relative w-full max-w-[260px]">
                      <div className="bg-white rounded-xl shadow-2xl p-4">
                        <h4 className="text-xs font-semibold text-gray-900 mb-3">Your Products</h4>
                        <div className="space-y-2 mb-4">
                          {['Course Bundle', 'Templates Pack', 'Community Access'].map((product, idx) => (
                            <div key={idx} className="flex items-center justify-between group py-1">
                              <div className="flex items-center gap-3 flex-1">
                                ...
                                <span className="text-[11px] text-gray-800 group-hover:text-gray-900">{product}</span>
                              </div>
