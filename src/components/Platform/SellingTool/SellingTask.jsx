  ...
  const accordionItems = [
    {
      id: 0,
      title: "Smart retries",
      content: "If your customer’s payment plan or subscription payment fails, Athena will automatically retry the card for you three times, recapturing 50% of failed subscription transactions."
    },
    {
      id: 1,
      title: "Automated incomplete purchase reminders",
      content: "Notify buyers of failed payments with automated email notifications to help recover missed sales opportunities."
    },
    {
      id: 2,
      title: "One-click payment controls",
      content: "Process customer refunds quickly and easily with a single click."
    },
    {
      id: 3,
      title: "Enhance the experience with financial integrations",
      content: "Athena Payments connects seamlessly with QuickBooks and Xero to sync transaction data in real time and automate bookkeeping."
    },
    {
        id: 4,
        title: "Simplified tax management",
        content: "Tax collection can be complex — leading to costly errors. TCommerce automates tax collection and remittance for U.S. and Canadian sales, and simplifies tax management for your sales in the EU and U.K."
    },
    {
        id: 5,
        title: "Streamlined B2B and B2C payments",
        content:"Athena’s invoicing solution helps you generate professional, customizable invoices, and collect payments directly through our platform. This feature simplifies payment collection by reducing manual tasks and improving financial management.."
    },
      ...
      <div className="container mx-auto max-w-7xl relative">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            Leave administrative tasks to the automation tools and solutions. Spend more time growing your business instead.
            </p>
                ...
                <div key={item.id} className="border-b border-gray-300">
                  ...
                  <AnimatePresence>
                    {openIndex === index && (
                      ...
                      >
                        <div className="pb-5 text-gray-700 text-sm leading-relaxed" style={{ fontFamily: 'Arial, sans-serif' }}>
                          {item.content}
                        </div>
                      </motion.div>
                    )}
