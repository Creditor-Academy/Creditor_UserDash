...
const features = [
  {
    ...
    description:"Cut down on abandoned carts by capturing all necessary customer payment information in just one click.",
    mockupBg: "bg-[#e8e8e8]",
  ...
  },
  {
    ...
    description:"Make it easy for customers to buy from you with multiple payment options including Apple Pay, Google Pay, Amazon Pay, Cash App, and Link by Stripe.",
    mockupBg: "bg-[#e8e8e8]",
  ...
  },
  {
    ...
    description: "Recover lost sales with automated follow-up emails to customers who start but do not complete their checkout.",
    mockupBg: "bg-[#e8e8e8]",
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-white/90 leading-relaxed max-w-3xl mx-auto">
            Make buying your learning products easy with flexible payment options and tools that streamline the checkout experience.
          </p>
