  ...
  const features = [
    {
      ...
      description: "Create a professional-looking and sounding sales page in just a few clicks with our AI landing page generator.",
      icon: Sparkles,
    },
    {
      id: 2,
      title: "AI course outline generator",
      description: "Speed up your workflow with our AI-powered tool that turns your ideas into a structured course outline.",
      icon: Wand2,
    },
    {
      id: 3,
      title: "Easy-to-use course builder",
      description: "Create, design, and rearrange lessons and chapters easily to build and edit your courses.",
      icon: Box,
    },
    {
      id: 4,
      title: "Bulk content importer",
      description: "Save time and effort — and launch your course sooner — by importing your existing content.",
      icon: Rocket,
    },
  ];
