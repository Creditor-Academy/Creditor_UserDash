      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            {/* Headline */}
            <h1 className="hero-heading text-white" style={{ 
            ...
            {/* Sub-headline */}
            <p className="hero-description text-white max-w-2xl" style={{ 
          ...
          <div className="relative">
              ...
              <div className="absolute bottom-8 right-8">
                <div className="bg-white/95 backdrop-blur-sm px-6 py-4 rounded-xl shadow-lg">
                  <div className="flex items-center gap-2">
                    <span className="text-2xl font-bold text-gray-900">ATHENA</span>
                    <div className="bg-blue-600 text-white px-3 py-1 rounded-lg">
                      <span className="text-sm font-bold">INSTRUCTIONAL DESIGN</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="absolute -bottom-6 -right-6 w-16 h-16 bg-white/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </div>
