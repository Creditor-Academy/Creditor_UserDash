    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <h2
            className="text-5xl md:text-6xl font-normal text-white mb-4 leading-tight"
            style={{ fontFamily: 'Georgia, Times New Roman, serif' }}
          >
            Our Process
          </h2>
          <p
            className="text-lg font-normal text-blue-100 max-w-3xl mx-auto leading-relaxed"
            style={{ fontFamily: 'Arial, sans-serif' }}
          >
            A proven methodology that transforms your vision into impactful
              ...
              return (
                <div key={index} className="relative z-10">
                  ...
                  <div className="bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 p-6 border border-gray-100 hover:border-gray-200 transform hover:-translate-y-1 h-[420px] flex flex-col">
                    {/* Number Badge */}
                    <div
                      className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-br ${step.color} text-white font-bold text-lg mb-4 shadow-md`}
                    >
                      {step.number}
                    </div>
                    ...
                    <div className="pt-0 border-t border-gray-100 mt-auto flex-shrink-0">
                      ...
                      <p
                        className="text-sm text-gray-700 font-normal leading-snug"
                        style={{ fontFamily: 'Arial, sans-serif' }}
                      >
                        {step.benefit}
                      </p>
