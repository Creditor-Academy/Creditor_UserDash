...
const AdminPayments = () => {
  ...
  useEffect(() => {
    setServicesPage(1);
  }, [consultationsSearch, consultationsFilter]);
  useEffect(() => {
    setServicesWebPage(1);
  }, [websitesSearch, websitesFilter]);
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-md p-3 text-sm">
              <div className="flex justify-between py-1">
                ...
                <span className="font-medium">{credits.sold}</span>
              </div>
              <div className="flex justify-between py-1">
              ...
              <div className="mt-2 h-2 bg-gray-200 rounded">
                <div
                  ...
                  style={{
                    width: `${Math.min((credits.used / Math.max(credits.sold, 1)) * 100, 100)}%`,
                  }}
                />
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="text-sm text-blue-600 font-medium">
                    Manage consultations and website services
                  </span>
                </div>
              </div>
                      ...
                      filteredConsultations
                        ...
                        .map(c => {
                          ...
                          return (
                            ...
                            >
                              <td className="px-6 py-4 font-mono text-xs text-gray-600 bg-gray-50">
                                {c.id}
                              </td>
