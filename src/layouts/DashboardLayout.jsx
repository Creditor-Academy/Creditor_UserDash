...
export function DashboardLayout() {
  ...
  return (
    <div className="flex min-h-screen w-full bg-gradient-to-br from-gray-50 to-white">
      ...
      {/* Main content area */}
      <div
        className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-[4.5rem]' : 'lg:ml-[17rem]'}`}
      >
        {/* Header - fixed at the top */}
        <header className={`fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200 h-16 transition-all duration-300 ${sidebarCollapsed ? 'lg:ml-[4.5rem]' : 'lg:ml-[17rem]'}`}>
          <DashboardHeader
