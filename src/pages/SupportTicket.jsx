      ...
      <div className="container py-8 max-w-3xl">
        <Card className="p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Your support ticket #12495 has been received. We'll get back to you
            within 24 hours.
          </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Button asChild>
              <Link to="/dashboard/support/tickets">View All Tickets</Link>
            </Button>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <div className="flex mb-6">
          <div className="w-full flex justify-between">
            ...
            >
              <div
                className={`h-8 w-8 rounded-full flex items-center justify-center ${step >= 1 ? 'bg-primary text-white' : 'bg-muted'}`}
              >
                1
              </div>
            ...
            >
              <div
                className={`h-8 w-8 rounded-full flex items-center justify-center ${step >= 2 ? 'bg-primary text-white' : 'bg-muted'}`}
              >
                2
              </div>
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="BILLING_PAYMENTS">
                      Billing & Payments
                    </SelectItem>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 flex items-start">
                ...
                <p className="text-sm text-amber-800">
                  By submitting this ticket, you confirm that the information
                  provided is accurate and relates to a legitimate issue you're
                  experiencing with our platform.
                </p>
              </div>
