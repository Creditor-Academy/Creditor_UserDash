    ...
    if (isAllowed) {
      try {
        ...
        if (selectedModuleForQuiz) {
          console.log(
            'Refreshing module quizzes for module:',
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  {Object.keys(moduleQuizzes).length > 0
                    ? Object.values(moduleQuizzes).reduce(
                        (sum, list) =>
                              ...
                              <div className="flex flex-col gap-2 ml-4">
                                {assessmentType === 'quiz' ? (
                                  ...
                                  <Button
                                    ...
                                    className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white text-sm font-medium rounded-lg shadow-sm transition-all duration-200 hover:shadow-md"
                                  >
                                    <Plus size={16} className="mr-2" /> Create
                                    Scenario
                                  </Button>
                              ...
                              loadingQuizzes[mod.id] ? (
                                ...
                                <div className="mt-4 space-y-4">
                                  {quizzes.map(quiz => (
                                    <div
                                      key={quiz.id}
                                      className="border rounded p-4 flex flex-col md:flex-row md:items-center md:justify-between bg-gray-50"
                                    >
                                      <div>
                                        ...
                                        <div className="text-xs text-gray-500 mb-1">
                                          Type: {quiz.type} | Max Attempts:{' '}
                                          {quiz.maxAttempts}
                                        </div>
                                        <div className="text-xs text-gray-500 mb-1">
                                          Score: {quiz.min_score} -{' '}
                                          {quiz.max_score} | Time:{' '}
                                          {quiz.time_estimate} min
                                        </div>
                                        <div className="text-xs text-gray-500 mb-1">
                                          Questions:{' '}
                                      ...
                                      <div className="flex gap-2 mt-2 md:mt-0">
                                        <Button
                                          onClick={() =>
                                            handleViewScores(quiz, course.id)
                                          }
                  ...
                  try {
                    ...
                    setModuleQuizzes(prev => {
                      ...
                      return {
                        ...prev,
                        [moduleId]:
                          prev[moduleId]?.filter(
                            q => q.id !== quizToDelete.id
                          ) || [],
                      };
                    });
                    setShowDeleteConfirmation(false);
