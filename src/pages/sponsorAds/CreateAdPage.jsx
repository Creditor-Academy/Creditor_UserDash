...
export default function CreateAdPage() {
  ...
  const handleImageUpload = e => {
    ...
    if (file) {
      // For frontend-only, create a local URL
  ...
  const handleSubmit = async e => {
    ...
    setLoading(true);
    try {
      await sponsorAdsService.createAd(formData);
      toast({
        title: 'Success',
  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Create Sponsor Ad</h1>
        <p className="text-gray-600 mt-2">
          Create a new sponsor advertisement for your LMS platform.
        </p>
      </div>
        ...
        <div className="lg:col-span-2">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Fill in the information for your sponsor ad.
              </CardDescription>
            </CardHeader>
            <CardContent>
